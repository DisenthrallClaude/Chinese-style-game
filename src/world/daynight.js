...
const KEYS = [
  {
    ...
    sun: 0x9fb6e8, sunI: 0.280,
    hemiSky: 0x2c4270, hemiGnd: 0x131a22, hemiI: 0.306,
    fill: 0x4a6ea8, fillI: 0.168, amb: 0.045,
    zen: 0x050a1a, hor: 0x14203a, gnd: 0x0a1020,
    cloudLit: 0x4a5a7c, cloudDark: 0x121826, cover: 0.36,
    fog: 0x16233c, fogD: 0.0030,
    star: 1.0, moon: 1.0,
    ray: 0.10, rayThr: 0.16,
    bloom: 0.95, bloomThr: 0.36,
    exposure: 1.28, contrast: 1.10, sat: 0.94,
    lift: [0.024, 0.036, 0.070], gain: [0.86, 0.94, 1.12],
    lantern: 1.0,
  },
  {
    h: 4.6, name: '平旦',
    sunEl: -7, sunAz: 60, moonEl: 30, moonAz: 240,
    sun: 0xd8a2e0, sunI: 0.735,
    hemiSky: 0x4a5a92, hemiGnd: 0x241e26, hemiI: 0.468,
    fill: 0x6a7ab0, fillI: 0.218, amb: 0.063,
    ...
    exposure: 1.16, contrast: 1.08, sat: 1.02,
    lift: [0.026, 0.024, 0.048], gain: [1.02, 0.96, 1.04],
    lantern: 0.85,
  },
  {
    h: 6.4, name: '日出',
  ...
  },
  {
    ...
    hemiSky: 0xa8c8ff, hemiGnd: 0x4a3a26, hemiI: 0.946,
    fill: 0x8fb4e8, fillI: 0.420, amb: 0.126,
    zen: 0x2f6ec4, hor: 0xc4d8e8, gnd: 0x8a9099,
    cloudLit: 0xfffaf2, cloudDark: 0x7a869a, cover: 0.40,
    fog: 0xbccfdc, fogD: 0.0021,
    star: 0.0, moon: 0.0,
    ray: 0.92, rayThr: 0.52,
    bloom: 0.60, bloomThr: 0.74,
    exposure: 1.0, contrast: 1.10, sat: 1.16,
    lift: [0.018, 0.026, 0.050], gain: [1.05, 1.01, 0.96],
    lantern: 0.0,
  },
  {
    h: 12.0, name: '正午',
    ...
    hemiSky: 0xbcd8ff, hemiGnd: 0x56452e, hemiI: 1.034,
    fill: 0x9cc0f0, fillI: 0.370, amb: 0.144,
    zen: 0x2664c8, hor: 0xd4e4f0, gnd: 0x94989c,
    cloudLit: 0xffffff, cloudDark: 0x8c98aa, cover: 0.34,
    fog: 0xc6d8e4, fogD: 0.0018,
    star: 0.0, moon: 0.0,
    ray: 0.62, rayThr: 0.66,
    bloom: 0.52, bloomThr: 0.86,
    exposure: 0.96, contrast: 1.11, sat: 1.12,
    lift: [0.014, 0.022, 0.044], gain: [1.02, 1.01, 0.99],
    lantern: 0.0,
  },
  {
    h: 16.4, name: '申时',
    ...
    hemiSky: 0xa8c4f0, hemiGnd: 0x584428, hemiI: 0.882,
    fill: 0x8ab0e4, fillI: 0.352, amb: 0.117,
    zen: 0x2d68b8, hor: 0xe0cfae, gnd: 0x8c8880,
    cloudLit: 0xfff0dc, cloudDark: 0x7e8494, cover: 0.42,
    fog: 0xcec2a8, fogD: 0.0022,
    star: 0.0, moon: 0.0,
    ray: 1.02, rayThr: 0.50,
    bloom: 0.62, bloomThr: 0.72,
    exposure: 1.0, contrast: 1.10, sat: 1.18,
    lift: [0.018, 0.024, 0.046], gain: [1.07, 1.01, 0.94],
    lantern: 0.0,
  },
  {
    h: 18.3, name: '金乌',
    ...
    hemiSky: 0x9aaee0, hemiGnd: 0x60401e, hemiI: 0.720,
    ...
    exposure: 1.04, contrast: 1.12, sat: 1.26,
    lift: [0.020, 0.018, 0.040], gain: [1.12, 0.99, 0.90],
    lantern: 0.30,
  },
  {
    h: 19.6, name: '黄昏',
    ...
    hemiSky: 0x6a76b4, hemiGnd: 0x46301e, hemiI: 0.522,
    fill: 0x6a7ec0, fillI: 0.236, amb: 0.081,
    ...
    exposure: 1.10, contrast: 1.12, sat: 1.24,
    lift: [0.022, 0.022, 0.050], gain: [1.10, 0.98, 0.94],
    lantern: 0.72,
  },
  {
    h: 21.0, name: '戌时',
    sunEl: -34, sunAz: 300, moonEl: 40, moonAz: 190,
    sun: 0x8ea4dc, sunI: 0.420,
    hemiSky: 0x3a4a80, hemiGnd: 0x1c2028, hemiI: 0.360,
    fill: 0x546ca4, fillI: 0.184, amb: 0.054,
    zen: 0x081334, hor: 0x2c3a5e, gnd: 0x161c2c,
    cloudLit: 0x5c6a92, cloudDark: 0x1a2032, cover: 0.42,
    fog: 0x22304c, fogD: 0.0031,
    star: 0.82, moon: 0.86,
    ray: 0.16, rayThr: 0.18,
    bloom: 0.95, bloomThr: 0.36,
    exposure: 1.24, contrast: 1.10, sat: 0.98,
    lift: [0.024, 0.034, 0.066], gain: [0.88, 0.95, 1.10],
    lantern: 1.0,
  },
];
