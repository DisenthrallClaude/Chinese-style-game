...
const KEYS = [
  {
    ...
    fog: 0x16233c, fogD: 0.00126,
    star: 1.0, moon: 1.0,
    ray: 0.05, rayThr: 0.16,
  ...
  },
  {
    ...
    fog: 0x5a5470, fogD: 0.00151,
    star: 0.34, moon: 0.42,
    ray: 0.19, rayThr: 0.24,
  ...
  },
  {
    ...
    hemiSky: 0x8ea6d2, hemiGnd: 0x4a3826, hemiI: 0.880,
    fill: 0x8aa8dc, fillI: 0.320, amb: 0.104,
    zen: 0x2a5090, hor: 0xf0a878, gnd: 0x5a4a48,
    cloudLit: 0xffc89a, cloudDark: 0x5a4a58, cover: 0.50,
    fog: 0xd8b498, fogD: 0.00143,
    star: 0.0, moon: 0.10,
    ray: 0.53, rayThr: 0.34,
    bloom: 0.72, bloomThr: 0.52,
    exposure: 1.124, contrast: 1.041, sat: 1.198,
  ...
  },
  {
    ...
    hemiSky: 0xa8c8ff, hemiGnd: 0x4a3a26, hemiI: 1.186,
    fill: 0x8fb4e8, fillI: 0.470, amb: 0.146,
    zen: 0x3d86d8, hor: 0xd6e8f2, gnd: 0x9aa4ac,
    cloudLit: 0xfffaf2, cloudDark: 0x7a869a, cover: 0.40,
    fog: 0xd2e2ea, fogD: 0.00109,
    star: 0.0, moon: 0.0,
    ray: 0.42, rayThr: 0.52,
    bloom: 0.55, bloomThr: 0.98,
    exposure: 1.060, contrast: 1.051, sat: 1.219,
  ...
  },
  {
    ...
    hemiSky: 0xbcd8ff, hemiGnd: 0x56452e, hemiI: 1.295,
    fill: 0x9cc0f0, fillI: 0.414, amb: 0.167,
    zen: 0x357ad8, hor: 0xe2eff6, gnd: 0xa2a8ac,
    cloudLit: 0xffffff, cloudDark: 0x8c98aa, cover: 0.34,
    fog: 0xdaeaf2, fogD: 0.00092,
    star: 0.0, moon: 0.0,
    ray: 0.29, rayThr: 0.66,
    bloom: 0.48, bloomThr: 1.10,
    exposure: 1.018, contrast: 1.060, sat: 1.177,
  ...
  },
  {
    ...
    hemiSky: 0xa8c4f0, hemiGnd: 0x584428, hemiI: 1.105,
    fill: 0x8ab0e4, fillI: 0.394, amb: 0.136,
    zen: 0x3a7cc8, hor: 0xece0c4, gnd: 0x9c9890,
    cloudLit: 0xfff0dc, cloudDark: 0x7e8494, cover: 0.42,
    fog: 0xe0d8c0, fogD: 0.00109,
    star: 0.0, moon: 0.0,
    ray: 0.47, rayThr: 0.50,
    bloom: 0.58, bloomThr: 0.96,
    exposure: 1.060, contrast: 1.051, sat: 1.240,
  ...
  },
  {
    ...
    hemiSky: 0x9aaee0, hemiGnd: 0x60401e, hemiI: 0.902,
    fill: 0x7e9ad8, fillI: 0.320, amb: 0.115,
    zen: 0x2a4e9c, hor: 0xf0a060, gnd: 0x6e5a4c,
    cloudLit: 0xffb877, cloudDark: 0x6a5464, cover: 0.52,
    fog: 0xdca476, fogD: 0.00122,
    star: 0.0, moon: 0.06,
    ray: 0.67, rayThr: 0.34,
    bloom: 0.80, bloomThr: 0.52,
    exposure: 1.102, contrast: 1.070, sat: 1.324,
  ...
  },
  {
    ...
    fog: 0xa87a66, fogD: 0.00139,
    star: 0.22, moon: 0.30,
    ray: 0.51, rayThr: 0.26,
  ...
  },
  {
    ...
    fog: 0x22304c, fogD: 0.00130,
    star: 0.82, moon: 0.86,
    ray: 0.07, rayThr: 0.18,
    bloom: 0.95, bloomThr: 0.36,
...
export class DayNight {
  ...
  apply(hour, instant = false) {
    ...
    // 墨线：白天描得实，入夜收一收，免得把暗部堵死
    e.godRay.uniforms.uInk.value = lerp(0.92, 0.46, s.lantern);
